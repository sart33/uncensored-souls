# Uncensored Souls — User Guide

## 1. General Information

**18+**  
When you launch the app for the first time, you will see an age restriction screen. If you are under 18 — press "No".
...
After entering:
- DeepSeek → chat becomes available  
- Novita → image generation is unlocked  
...
When opening the gallery from chat, the same category will be used.
...
If you plan to generate nude images, it is recommended to explicitly describe body features as well.
...
- 500 tokens → minimal cost  
- 2000+ tokens → long, detailed responses  
